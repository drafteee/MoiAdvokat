export const userConstants = {
  ...
  PreCheckRegister: {
    REQUEST: "PRE_CHCECK_REGISTER_REQUEST",
    SUCCESS: "PRE_CHCECK_REGISTER_SUCCESS",
    FAILURE: "PRE_CHCECK_REGISTER_FAILURE",
  },
  GetUserTypes: {
  ...
  GetFunctions: {
    REQUEST: "GET_FUNCTIONS_REQUEST",
    SUCCESS: "GET_FUNCTIONS_SUCCESS",
    FAILURE: "GET_FUNCTIONS_FAILURE",
  },
  UpdateRoleFunctions: {
    REQUEST: "UPDATE_ROLE_FUNCTIONS_REQUEST",
    SUCCESS: "UPDATE_ROLE_FUNCTIONS_SUCCESS",
    FAILURE: "UPDATE_ROLE_FUNCTIONS_FAILURE",
  },
};
